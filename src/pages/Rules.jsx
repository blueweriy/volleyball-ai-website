  ...
  return (
    <div style={{ paddingLeft: "3rem", paddingRight: "3rem" }}>
      ...
      <section id="how-to-play" className="mb-12">
        ...
        <p>
          The ball is served from behind the end line, over the net into the opponent’s court.
          Each team is allowed up to three successive contacts (passes, sets, spikes) to return the ball.
        </p>
        <p>
          Players rotate clockwise to new positions each time they win back the serve, ensuring
          every member participates both in front-row attacks and back-row defense.
        </p>
      ...
      <section id="court-dimensions" className="mb-12">
        ...
        <p>
          A standard volleyball court measures 18 m long by 9 m wide (59 ft × 29½ ft),
          divided in half by a central net. Boundaries are marked on the floor, and
          any part of the ball touching the line is considered in play.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-4">
      ...
      <section id="basic-rules" className="mb-12">
        ...
        <p>
          Play begins with a serve and continues until the ball touches the ground,
          a fault occurs, or the ball is played out of bounds.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-4">
      ...
      <section id="scoring" className="mb-12">
        ...
        <p>
          Modern volleyball uses rally scoring: every rally results in a point,
          regardless of which team served. Matches are typically best‐of‐five sets.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-4">
      ...
      <section id="game-formats">
        ...
        <p>Volleyball has several variations played worldwide, each with unique rules and team sizes.</p>
        <ul className="list-disc list-inside space-y-2 mt-4">
