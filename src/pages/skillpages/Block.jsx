  ...
  return (
    <div className="bg-white text-gray-900 py-16 px-8 md:px-16 lg:px-32 max-w-4xl mx-auto leading-relaxed">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>
            <a href="https://youtu.be/4AF6E289zk0" target="_blank" className="text-blue-600 hover:underline">
              Front-Row Blocking Basics
            </a>
          </li>
          <li>
            <a href="https://youtu.be/KX3vXnYSRnU" target="_blank" className="text-blue-600 hover:underline">
