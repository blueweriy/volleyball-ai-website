  ...
  return (
    <div className="bg-white text-gray-900 py-16 px-8 md:px-16 lg:px-32 max-w-4xl mx-auto leading-relaxed">
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>
            <a href="https://youtu.be/6AnCdkMcTIk" target="_blank" className="text-blue-600 hover:underline">
              Pro Digging Techniques
            </a>
          </li>
          <li>
            <a href="https://youtu.be/LXqnrN_FG-I" target="_blank" className="text-blue-600 hover:underline">
              Advanced Dig Drills
            </a>
          </li>
        </ul>
