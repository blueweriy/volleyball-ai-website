    ...
    <div className="bg-white text-gray-900 py-16 px-8 lg:px-20 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">Jump, bound, and sprint drills to build explosive power.</p>
          <span className="mt-4 inline-block text-indigo-600 font-medium hover:underline">Start →</span>
        </Link>
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">Leg and upper-body routines for muscle and power.</p>
          <span className="mt-4 inline-block text-indigo-600 font-medium hover:underline">Start →</span>
        </Link>
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">Endurance circuits to keep you in the rally longer.</p>
          <span className="mt-4 inline-block text-indigo-600 font-medium hover:underline">Start →</span>
        </Link>
      </div>
    </div>
