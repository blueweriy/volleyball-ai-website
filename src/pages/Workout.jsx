        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-900 leading-relaxed">
              Explosive jump and landing drills to boost vertical leap and
              reaction speed.
            </p>
          ...
          >
            ...
            <p className="text-gray-900 leading-relaxed">
              Foundational leg and upper-body lifts to build power and injury
              resilience.
            </p>
            <span className="mt-4 inline-block text-gray-900 font-medium">
              Start →
          ...
          >
            ...
            <p className="text-gray-900 leading-relaxed">
              Interval and circuit routines to sustain high intensity through
              long matches.
            </p>
            <span className="mt-4 inline-block text-gray-900 font-medium">
              Start →
          ...
          >
            ...
            <p className="text-gray-900 leading-relaxed">
              Mobility, stability, and care protocols to stay healthy and
              recover.
            </p>
